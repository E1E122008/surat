<div class="sidebar bg-gray-50 shadow-md rounded-lg p-4 w-64 overflow-y-auto" id="sidebar">
    ...
    <div class="logo-container text-center mb-6">
        ...
        <a class="navbar-brand fw-bold text-center text-xl text-primary hover:opacity-80 transition-opacity duration-200"
            style="color: #ffffff !important;" href="{{ route('dashboard') }}">
            SIAP BROH !!!
        </a>
    </div>

    <h2 class="text-lg font-bold mb-2 text-white" style="color: white;">Menu Utama</h2>
    ...
    <h2 class="text-lg font-bold mb-2 text-white" style="color: white;">Menu Tambahan</h2>
    <ul class="list-none p-0">
        @auth
...
<style>
    ...
    .logo-image {
        width: auto;
        height: 85px;
        /* Ukuran diperbesar menjadi 65px */
        max-width: 100%;
    ...
    @media (max-width: 768px) {
        .logo-image {
            height: 58px;
            /* Ukuran untuk mobile juga disesuaikan */
        }
    }
