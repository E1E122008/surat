...
@section('content')
    <div class="min-h-screen bg-gray-100" style="max-width: 1400px; margin: auto; padding: 20px;">
        <div class="mb-4">
            <h2 class="header h2"><strong>📂 Surat Perintah Perjalanan Dinas</strong> / <span style="color: gray;"> SPPD Dalam
                    Daerah</span></h2>
        </div>
                    ...
                    <div class="flex space-x-2">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                <li>
                                    <a class="dropdown-item {{ !isset($sortOrder) || $sortOrder == 'desc' ? 'active bg-primary text-white' : '' }}"
                                        href="{{ route('sppd-dalam-daerah.index', array_merge(request()->query(), ['sort' => 'desc'])) }}">
                                        Terbaru ke Terlama
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item {{ isset($sortOrder) && $sortOrder == 'asc' ? 'active bg-primary text-white' : '' }}"
                                        href="{{ route('sppd-dalam-daerah.index', array_merge(request()->query(), ['sort' => 'asc'])) }}">
                                        Terlama ke Terbaru
                                    </a>
                                </li>
                            </ul>
                        ...
                        <form action="{{ route('sppd-dalam-daerah.index') }}" method="GET" class="flex items-center">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="Cari SPPD Dalam Daerah..." class="form-control">
