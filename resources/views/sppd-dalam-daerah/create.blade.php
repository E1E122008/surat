            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_surat" id="no_surat"
                        class="form-control @error('no_surat') is-invalid @enderror" value="{{ $nomorSurat }}">
                    @error('no_surat')
                ...
                <div class="form-group">
                    ...
                    <input name="tujuan" id="tujuan" rows="4"
                        class="form-control @error('tujuan') is-invalid @enderror" style="height: 50px;"
                        required>{{ old('tujuan') }}</input>
                    @error('tujuan')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
