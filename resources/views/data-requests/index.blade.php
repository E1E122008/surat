                                ...
                                <tbody>
                                    @forelse($approvalRequests as $request)
                                        <tr class="request-row" data-status="{{ $request->status }}">
                                            ...
                                            <td class="text-center">
                                                {{ $request->tanggal_surat ? $request->tanggal_surat->format('d M Y') : '-' }}
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-light" data-bs-toggle="modal"
                                                    data-bs-target="#detailModal{{ $request->id }}" title="Detail">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        @if ($request->status === 'pending' && auth()->user()->role !== 'monitor')
                            <form action="{{ route('data-requests.cancel', $request->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-danger" onclick="confirmCancelRequest(this)"
                                    title="Batal Kirim">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('data-requests.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="letter_type" class="form-label">Jenis Surat <span
                            ...
                            <div class="col-md-6">
                                <label for="no_surat" class="form-label">No. Surat <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Masukkan No.HP yang bisa di hubungi untuk info
                                    selanjutnya.</small>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <label for="perihal" class="form-label">Perihal <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" id="perihal" name="perihal" rows="2" placeholder="Tuliskan perihal surat"
                                    required></textarea>
                            </div>
                            <div class="col-12">
