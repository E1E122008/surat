...
@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form action="{{ route('surat-keluar.update', $suratKeluar->id) }}" method="POST" enctype="multipart/form-data" id="editForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        @php
                            $lampiran = is_array($suratKeluar->lampiran) ? $suratKeluar->lampiran : json_decode($suratKeluar->lampiran, true);
                        @endphp
