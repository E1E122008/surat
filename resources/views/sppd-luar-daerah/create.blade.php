...
@section('content')
    <div class="form-section">
        <div class="form-header">
            <h2>Tambah SPPD Luar Daerah</h2>
        </div>

        <form action="{{ route('sppd-luar-daerah.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="form-group">
                    ...
                    <input type="text" name="no_surat" id="no_surat"
                        class="form-control @error('no_surat') is-invalid @enderror" value="{{ $nomorSurat }}" readonly>
                    @error('no_surat')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tujuan" id="tujuan"
                        class="form-control @error('tujuan') is-invalid @enderror" value="{{ old('tujuan') }}" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <textarea name="perihal" id="perihal" rows="2" class="form-control @error('perihal') is-invalid @enderror"
                ...
                <div class="form-group">
                    ...
                    <textarea name="nama_petugas" id="nama_petugas" rows="2"
                        class="form-control @error('nama_petugas') is-invalid @enderror" required>{{ old('nama_petugas') }}</textarea>
                    @error('nama_petugas')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-actions">
                <a href="{{ route('sppd-luar-daerah.index') }}" class="btn btn-cancel">Batal</a>
