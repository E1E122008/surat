        ...
        <form action="{{ route('spt-luar-daerah.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="form-group">
                    ...
                    <input type="text" name="no_surat" id="no_surat"
                        class="form-control @error('no_surat') is-invalid @enderror" value="{{ $nomorSurat }}" required>
                    @error('no_surat')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <textarea name="perihal" id="perihal" rows="4" class="form-control @error('perihal') is-invalid @enderror"
