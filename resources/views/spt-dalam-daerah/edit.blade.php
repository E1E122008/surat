        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold">Edit SPT Dalam Daerah</h2>
                    </div>
                

                    <form action="{{ route('spt-dalam-daerah.update', $sptDalamDaerah->id) }}" method="POST" enctype="multipart/form-data" id="editForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                value="{{ old('tanggal', $sptDalamDaerah->tanggal->format('Y-m-d')) }}" required>
                                @error('tanggal')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                value="{{ old('tujuan', $sptDalamDaerah->tujuan) }}" required>
                                @error('tujuan')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="perihal" id="perihal" rows="2"
                                    ...
                                    required
                                >{{ old('perihal', $sptDalamDaerah->perihal) }}</textarea>
                                @error('perihal')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                required
                                >{{ old('nama_petugas', $sptDalamDaerah->nama_petugas) }}</textarea>
                                @error('nama_petugas')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                @php
                                    $lampiran = is_array($sptDalamDaerah->lampiran) ? $sptDalamDaerah->lampiran : json_decode($sptDalamDaerah->lampiran, true);
                                @endphp
                        ...
                        <div class="button-container">
                            <a href="{{ route('spt-dalam-daerah.detail', $sptDalamDaerah->id) }}" class="btn-cancel">
                                Batal
                            </a>
